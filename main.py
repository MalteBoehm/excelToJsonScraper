...
def addFoodCategoryToAllergenList(deFoodCategoryName, engFoodCategoryName,
    ...
    for rownum in range(fromRow, toRow):
        ...
        allergens['names'], allergens['englishNames'] = convertsNames(row_values[9]), convertsNames(row_values[10])
        allergens['deFoodCategory'], allergens['engFoodCategory'] = deFoodCategoryName, engFoodCategoryName
        allergens['deSpecificFood'], allergens['engSpecificFood'] = deGroupOfFood, engGroupOfFood
        allergens['laktose'], allergens['gluten'] = row_values[2], row_values[3]
        allergens['histamin'], allergens['histaminWirkung'] = row_values[4], row_values[5]
        allergens['weitereArmineWirkung'], allergens['liberatorWirkung'] = row_values[6], row_values[7]
